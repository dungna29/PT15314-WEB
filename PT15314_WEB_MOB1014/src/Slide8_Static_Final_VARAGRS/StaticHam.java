...
public class StaticHam {
   ...
   private String subject;
    ...
    StaticHam (String subject) {
        this.subject = subject;
    }
     
    public void print() {
        System.out.println("Subject = " + subject);
        System.out.println("TRƯỜNG = " + ClassTemp.Temp);
    }
     
    public static void thayDoiTen(String website) {
        ClassTemp.Temp = website;
    }
     
    public static void main(String[] args) {       
        StaticHam ex1 = new StaticHam("CHÀO MỪNG ĐẾN VỚI HÀM STATIC");
        ex1.thayDoiTen("ĐẠI HỌC BÁCH KHOA");
        ex1.print();
        System.out.println("----");
        StaticHam.thayDoiTen("ĐẠI HỌC FPT");
        ex1.print();
    }
