...
public class S1_XuLyChuoi {
    ...
    public static void main(String[] args) {
        ...
        if ("Dao Duy Anh".equals("Dao Duy Anh")) {
            System.out.println("Chúc mừng bạn đăng nhập thành công equals");
        }
        if ("Dao Duy Anh".contains("Anh")) {
            System.out.println("Chúc mừng bạn đăng nhập thành công contains");
        }
        if ("Dao Duy Anh".equalsIgnoreCase("dao duy anh")) {
            System.out.println("Chúc mừng bạn đăng nhập thành công equalsIgnoreCase");
        }
        ...
        arrListName.add("Nguyen Anh Dung");
        arrListName.add("Dao Duy Anh");
        arrListName.add("Dao Duy Anh 1");
        arrListName.add("Dao Duy Anh 2");
        arrListName.add("Nguyen Anh Dung 2");
        arrListName.add("Nguyen Anh Dung 3");
        arrListName.add("Dao Nguyen Anh Dung 3");
        //in ra 1 danh sách những người họ Dao
